...
return array (
  ...
  array (
    ...
    array (
      ...
      array (
        'type' => 'gettext',
        'base_dir' => '/vagrant/module/Application/config/../language',
        'pattern' => '%s.mo',
      ),
    ),
  ),
  ...
  array (
    ...
    'template_map' => 
    array (
      'layout/layout' => '/vagrant/module/Application/config/../view/layout/layout.phtml',
      'application/index/index' => '/vagrant/module/Application/config/../view/application/index/index.phtml',
      'error/404' => '/vagrant/module/Application/config/../view/error/404.phtml',
      'error/index' => '/vagrant/module/Application/config/../view/error/index.phtml',
      'oauth/authorize' => '/vagrant/vendor/zfcampus/zf-oauth2/config/../view/zf/auth/authorize.phtml',
      'oauth/receive-code' => '/vagrant/vendor/zfcampus/zf-oauth2/config/../view/zf/auth/receive-code.phtml',
    ),
    'template_path_stack' => 
    array (
      0 => '/vagrant/module/Application/config/../view',
      1 => '/vagrant/vendor/zfcampus/zf-apigility-documentation/config/../view',
      2 => '/vagrant/vendor/zfcampus/zf-oauth2/config/../view',
    ),
    'strategies' => 
    array (
      0 => 'ViewJsonStrategy',
  ...
  array (
    ...
    array (
      'paths' => 
      array (
        0 => '/vagrant/vendor/zfcampus/zf-apigility/config/../asset',
      ),
    ),
