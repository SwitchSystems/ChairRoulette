...
HOSTNAME="chairroulette.vagrant"

# Install packages
aptitude update
aptitude safe-upgrade -y
aptitude install -y apache2 php5 php5-intl php5-gd php5-memcached php5-xdebug php5-cli php5-mcrypt php5-mysql memcached php5-ldap php5-curl
...
</VirtualHost>" > /etc/apache2/sites-available/$HOSTNAME
a2ensite $HOSTNAME
